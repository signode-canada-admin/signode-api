...
#     PP_json = premium_plus_extraction_algo(pdf_file)
    ...
    sheet[cell_name["customer_name"]] = PP_json["customer_name"]
    sheet[cell_name["ship_to"]] = PP_json["ship_to"]
    sheet[cell_name["warehouse"]] = PP_json["warehouse"]
    sheet[cell_name["order_type"]] = PP_json["order_type"]
